...
window.APP_CONFIG = {
  ...
  getApiUrl: function() {
    ...
    if (currentHost === '34.29.235.29') {
      const apiUrl = 'http://34.16.74.187/api';
    ...
    console.log('Domain check - includes .pp.ua:', currentHost.includes('.pp.ua'));
    console.log('Domain check - includes .com:', currentHost.includes('.com'));
